...
<?php if(isset($_SESSION['art'])){
    ...
    unset($_SESSION['art']);}?>
<form action="dodaj-nau.php" method="POST">  
                        <div class="form-outline mb-4">
                        <label class="form-label">Wpisz numer ID konta aby mianować nauczyciela </label><br>
...
$sql = "UPDATE konto SET rodzaj_konta=2 WHERE id_konto=$id";

if ($polaczenie->query($sql) === TRUE) {
    $_SESSION['art']="Edytowano uzytkownika w systemie";
    header('Location:dodaj-nau.php');
} else {
